...
class Twig_Tests_TemplateTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetAttributeExceptions($template, $message, $useExt)
    {
        ...
        $templates = array(
            $name => $template.$useExt, // appending $useExt makes the templates content unique
        );
    ...
    public function getAttributeExceptions()
    {
        $tests = array(
            ...
            array('{{ magic_exception.test }}', 'An exception has been thrown during the rendering of a templates ("Hey! Don\'t try to isset me!") in "%s" at line 1.', false),
        );
